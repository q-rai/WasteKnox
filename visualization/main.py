...
# FACTS
FACTS = [
         '''<p class=fact>Last year, people in Knoxville produced the weight of over {} {} in non-recyclable trash! <br /> <br /> {} <br /> <br /> <br /> That's the same as {} {}! <br /> <br /> {} <br /> <br /> {}</p>'''.format(94, "Sunspheres", repeatImage("Sunspheres", 94, "70px"), 757, "Space Shuttles", repeatImage("Space Shuttles", 575, "30px"), learnMore),
...
#         '''<p class=fact>Downtown Knoxville Recycling Center collected 470,937 lbs of recyclables. That's the weight of over {} {}! <br /> <br /> {}  <br /> <br /> That's the same as {} {}! <br /> <br /> {} <br /> <br /> {} </p>'''.format(3.1, "Space Shuttles", repeatImage("Space Shuttles", 3.1, "70px"), 20, "School Buses", repeatImage("School Buses", 20, "30px"), learnMore),
         '''<p class=fact>Curb-Side Pickup collected 8,538,391 lbs of recyclables. That's the weight of over {} {}! <br /> <br /> {}  <br /> <br /> That's the same as {} {}! <br /> <br /> {}  <br /> <br /> {} </p>'''.format(7.1, "Sunspheres", repeatImage("Sunspheres", 7.1, "70px"), 56.9, "Space Shuttles", repeatImage("Space Shuttles", 56.9, "70px"), learnMore),
]
